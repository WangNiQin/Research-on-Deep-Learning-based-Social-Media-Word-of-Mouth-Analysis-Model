...
class MnistBags(data_utils.Dataset):
    ...
    def _create_bags(self):
        if self.train:
            loader = data_utils.DataLoader(datasets.('../datasets',
                                                          train=True,
                                                          download=True,
...
if __name__ == "__main__":
    ...
    train_loader = data_utils.DataLoader(Bags(target_number=9,
                                                   mean_bag_length=10,
                                                   var_bag_length=2,
                                                   num_bag=100,
                                                   seed=1,
    ...
    test_loader = data_utils.DataLoader(Bags(target_number=9,
                                                  mean_bag_length=10,
                                                  var_bag_length=2,
                                                  num_bag=100,
                                                  seed=1,
